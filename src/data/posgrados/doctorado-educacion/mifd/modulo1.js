      ...
      subthemes: [
        /* ---------- 1.1 Paradigma presagio-producto (enriquecido) ---------- */
        {
          ...
          content: [
            ...
            /*  IMAGEN DE SÍNTESIS  */
            {
              ...
              caption:
                "Figura 2. Relación lineal propuesta por el paradigma presagio-producto.",
            },
          ],
        },
        /* ------------------------------------------------------------------- */
        ...
        /* ---------- 1.2 Paradigma proceso-producto (enriquecido) ---------- */
        {
          ...
          content: [
            ...
            {
              type: "paragraph",
              text: "Activo entre las décadas de 1960-1980, este paradigma se propuso \
            ...
            /* — Imagen / infografía comparativa — */
            {
              ...
              caption:
                "Figura 3. Modelo básico “proceso → producto” (adaptado de Dunkin & Biddle, 1974).",
            },
          ],
        },
        /* ------------------------------------------------------------------ */
        ...
        /* ---------- 1.3 Paradigma mediacional (texto ampliado + acordeón múltiple) --- */
        {
          ...
          content: [
            ...
            /* — Imagen ilustrativa — */
            {
              ...
              caption:
                "Figura 4. Modelo mediacional de aprendizaje con andamiaje graduado.",
            },
          ],
        },
        /* ------------------------------------------------------------------ */
        ...
        /* ---------- 1.4 Paradigma ecológico (texto + acordeón + vídeo) ---------- */
        {
          ...
          content: [
            ...
            /* — vídeo final — */
            {
              ...
              caption:
                "7 min · Experiencias de escuelas que aplican el enfoque ecológico.",
            },
          ],
        },
        /* ------------------------------------------------------------------------------ */
